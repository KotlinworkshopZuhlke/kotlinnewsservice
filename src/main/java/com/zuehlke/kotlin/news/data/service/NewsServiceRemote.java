...
public class NewsServiceRemote {
    ...
    public NewsFeed fetchNews() {
        ...
        /*
        TODO Step 6 Bonus: Replace the kotlin.Result with your own FetchResult Type, which can be either a Success or
         a Failure. You can use sealed class for that,
         */
    }
}
